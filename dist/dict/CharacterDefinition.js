...
class CharacterDefinition {
     ...
     */
    constructor() {
        Object.defineProperty(this, "character_category_map", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "compatible_category_map", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "invoke_definition_map", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    lookup(ch) {
        let class_id = null;
        if (this.invoke_definition_map === null)
            return;
        var code = ch.charCodeAt(0);
        if (SurrogateAwareString.isSurrogatePair(ch)) {
...
//# sourceMappingURL=CharacterDefinition.js.map